const TEXTS = {
    ...
    message5: 'У меня есть для тебя подарки, но мне нужна твоя помощь....',
    button5: 'Какая?',
    ...
    message9: 'Помоги мне их найти, а я в долгу не останусь - так уж и быть, расскажу, где спрятаны твои подарки!!!!!',
    button9: 'Ну.. Хорошо!',
    message10: 'Ну хорошо, я согласен тебе помочь! Что нужно сделать?',
    message11: 'Отлично! Совсем скоро тебе будет доступна игра. В ней тебе надо будет вводить номера найденных уточек. Номер сможешь найти на пузике каждого утенка!',
    button11: 'Что еще?',
    message12: 'Звучит просто! Что-то еще?',
    message13: 'Правила следующие: в игре есть 3 контрольных точки на позициях 10, 25 и 50, что означает количество тобой найденных уточек. При достижении каждой контрольной точки, тебе будет доступна подсказка по поиску твоего подарка! Если тебе понадобится какая-то помощь - в поле для ввода ответов достаточно будет ввести слово "помощь" или "?" и я расскажу тебе рандомный факт о месте предположительного нахождения какого-то из братанов. А теперь удачи в поисках! Я пойду пока хлеб похаваю!',
    button13: 'Я готов начать игру!'
};
...
let foundDuck = (duck) => {
    let imagePath = duck.image_path ? duck.image_path : 'images/duck-left.png';
    return `
        <div class="duck-card revealed" data="${duck._id}">
            <img src="${imagePath}" alt="Утка ${duck.duck_number}">
